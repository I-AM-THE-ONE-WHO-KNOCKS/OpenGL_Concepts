...
float quad[] = {0.5, 0.5,  1.0, 0.0, 0.0, 1.0, 1.0, 1.0,  
...
void init() {
    ...
    shader = new Shader();
    programID = shader->init("shader_FBO.vert", "shader_FBO.frag");
	...
	activeTextureLocation1 = 
		glGetUniformLocation(programID, "activeTexture1");
    ...
    offScreenFBO = initializeFBO(1024, 1024);
...
void drawScene() {
	...
	glUniform1i(activeTextureLocation1, 1);

    glm::mat4 modelMatrix;

    modelMatrix = glm::translate(glm::vec3(-0.5, 0.0, -2.0));
    modelMatrix = glm::rotate(modelMatrix,
                              glm::radians(angle+100),
